...
function ESX.RefreshJobs2()
  local Jobs2 = {}
  local jobs2 = MySQL.query.await('SELECT * FROM jobs')
  ...
  local job2Grades = MySQL.query.await('SELECT * FROM job_grades')
  ...
  if not Jobs2 then
    -- Fallback data, if no jobs exist
    ESX.Jobs2['unemployed2'] = {label = 'discoccupato',
                              grades = {['0'] = {grade = 0, label = 'discoccupato', salary = 200, skin_male = {}, skin_female = {}}}}
  else
    ESX.Jobs2 = Jobs2
  end
end
